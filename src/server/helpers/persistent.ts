...
/**
 * Ensure that the current process is the main process.
 * @param fnName The name of the function that is being invoked for logging purposes.
 * @throws If the current process is not the main process.
 */
